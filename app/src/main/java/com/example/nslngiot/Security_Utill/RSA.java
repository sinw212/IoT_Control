...
//    } 해당 앱에서는 사용되지 않음
    ...
    public static String rsaEncryption(char[] plainData, char[] stringPublicKey) {
        ...
        byte[] byteEncryptedData = new byte[plainData.length];
    ...
    public static String rsaDecryption(char[] encryptedData, char[] stringPrivateKey) {
        ...
        KeyFactory keyFactory;
        byte[] byteEncryptedData = new byte[encryptedData.length];
        byte[] byteDecryptedData = new byte[byteEncryptedData.length];
        String str_dec="";
